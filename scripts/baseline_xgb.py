...
ckpt_dir = "./ckpt/model"
results_file_path = './result/baseline_xgb_results_summary.csv'  # Update results file path
...
def main():
    ...
    for random_seed in random_seeds:
        ...
        for fold, (train_index, test_index) in enumerate(kf.split(inputs)):
            ...
            xgb_model = MultiOutputRegressor(xgb.XGBRegressor(n_estimators=100, random_state=random_seed, tree_method='hist', device="cuda"))
            # xgb_model.fit(train_features, train_targets.ravel())  # Ensure targets are 1D
