...
# 定义文件路径列表
file_paths = [
    '/root/CPP_Customize_Transfer_Learning/virtual_database/DBCz.csv',
    '/root/CPP_Customize_Transfer_Learning/virtual_database/PA.csv',
    '/root/CPP_Customize_Transfer_Learning/virtual_database/ICz.csv'
]
save_directory = '/root/CPP_Customize_Transfer_Learning/result/reverse_design'  # 修改为您希望的保存目录
