...
ckpt_dir = "./ckpt/model"
results_file_path = './result/base_results_summary.csv'
...
def main():
    ...
    for random_seed in random_seed_list:
        ...
        for fold, (train_index, test_index) in enumerate(kf.split(inputs)):
            ...
            test_dataset = CustomDataset(test_inputs, test_labels, file_paths, sampling_frequency, random_seed, is_train=False)
