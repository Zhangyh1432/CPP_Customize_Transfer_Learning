...
if __name__ == '__main__':
    ...
    dataset = CustomDataset('./Pretrain/data/augmented_data.csv', './Pretrain/data/augmented_labels.csv')
    ...
    for epoch in range(epochs):  # loop over the dataset multiple times
        ...
        if(epoch%interval == 0):
            torch.save(model, "./Pretrain/ckpt/" + str(epoch) + ".pth")

    test_dataset = CustomDataset('./Pretrain/data/test_data.csv', './Pretrain/data/test_labels.csv')
